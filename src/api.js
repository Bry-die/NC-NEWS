...
export const getArticles = async (slug, sort_by, per, page) => {
  const URL = slug
    ? `${BASE_URL}/topics/${slug}/articles?sort_by=${sort_by}&p=${page}&limit=${per}`
    : `${BASE_URL}/articles?sort_by=${sort_by}&p=${page}&limit=${per}`;
